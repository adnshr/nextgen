...
<%@ page import="edu.wustl.catissuecore.actionForm.ThawEventParametersForm"%>
				...
				<span class="grey_ar_s capitalized">[<bean:message key="date.pattern" />]</span>&nbsp;</td>
                  ...
                  <td align="left"><span class="black_ar"><autocomplete:AutoCompleteTag property="timeInHours"
										optionsList = '${requestScope.hourList}'
										  initialValue='${thawEventParametersForm.timeInHours}'
											styleClass="black_ar"
                   ...
                   <autocomplete:AutoCompleteTag property="timeInMinutes"
							  ...
							  initialValue='${thawEventParametersForm.timeInMinutes}'
							  styleClass="black_ar"
