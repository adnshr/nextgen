...
<head>
	...
	<script language="JavaScript">
	   ...
	   function onSubmitButtonClicked()
		{
			var action = 'AssignNewPassword.do?access=denied';
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="maintable">
  ...
  <html:form action="AssignNewPassword.do">
  ...
  <tr>
    <td class="tablepadding"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td align="left" class="tr_bg_blue1"><span class="blue_ar_b">&nbsp;Set New Password</span></td>
      </tr>
      <tr>
        <td align="center" valign="top" class="showhide"><table width="100%" border="0" cellpadding="3" cellspacing="0">
