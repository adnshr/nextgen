...
-- INCREMENT SEQUNCE FOR CONTAINER_TYPE
ALTER SEQUENCE CATISSUE_CONTAINER_TYPE_SEQ INCREMENT BY 2;
SELECT CATISSUE_CONTAINER_TYPE_SEQ.NEXTVAL FROM DUAL;
ALTER SEQUENCE CATISSUE_CONTAINER_TYPE_SEQ INCREMENT BY 1;
