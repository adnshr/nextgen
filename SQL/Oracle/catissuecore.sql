...
create table CATISSUE_SPECIMEN_PROTOCOL (
   ...
   DERIV_LABEL_FORMAT varchar(255),
   ALIQUOT_LABEL_FORMAT varchar(255),
   primary key (IDENTIFIER)
);
...
CREATE sequence CATISSUE_AUDIT_EVENT_PARAM_SEQ NOCACHE;
CREATE sequence CATISSUE_AUDIT_EVENT_DET_SEQ NOCACHE;
CREATE sequence CATISSUE_AUDIT_EVENT_LOG_SEQ NOCACHE;
CREATE sequence LOGIN_EVENT_PARAM_SEQ NOCACHE;
