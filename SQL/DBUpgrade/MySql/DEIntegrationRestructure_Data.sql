...
delete T1
from DYEXTN_ENTITY_MAP_CONDNS T1, DYEXTN_ENTITY_MAP_CONDNS T2
where T1.form_context_id = T2.form_context_id
...
insert into dyextn_abstract_form_context (form_label,container_id,hide_form)
(select fc.study_form_label,em.container_id,0 from dyextn_entity_map em,dyextn_form_context fc
