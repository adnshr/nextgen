...
ALTER TABLE catissue_audit_event_details, change CURRENT_VALUE CURRENT_VALUE text default NULL;
ALTER TABLE catissue_audit_event_details, change PREVIOUS_VALUE PREVIOUS_VALUE text default NULL;
